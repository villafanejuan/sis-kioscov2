    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">
                <i class="fas fa-users text-gray-600 mr-2"></i>Gestión de Clientes
            </h1>
            <div class="flex gap-3">
                <?php if ($isAdmin): ?>
                    <a href="?show_inactive=<?php echo $showInactive ? '0' : '1'; ?>"
                        class="bg-gray-100 border border-gray-300 hover:bg-gray-200 text-gray-800 px-4 py-2 rounded-none transition">
                        <i class="fas fa-<?php echo $showInactive ? 'eye-slash' : 'eye'; ?> mr-2"></i>
                        <?php echo $showInactive ? 'Ocultar Inactivos' : 'Ver Inactivos'; ?>
                    </a>
                <?php endif; ?>
                <button onclick="toggleAddForm()"
                    class="bg-gray-900 hover:bg-black text-white px-4 py-2 rounded-none transition shadow-none">
        ...
        <!-- Formulario Agregar -->
        <div id="addForm" class="hidden bg-white border border-gray-300 shadow-none mb-6 p-6">
            ...
            <form method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2 flex gap-2">
                    <button type="button" onclick="toggleAddForm()"
                        class="bg-gray-100 border border-gray-300 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-none">Cancelar</button>
                    <button type="submit" name="add_customer"
                        class="bg-gray-900 hover:bg-black text-white px-4 py-2 rounded-none shadow-none">Guardar</button>
                </div>
            </form>
        </div>
        ...
        <div class="mb-4 relative">
            ...
            <input type="text" id="table_search"
                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-none leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-gray-500 focus:border-gray-500 sm:text-lg shadow-none"
            ...
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php foreach ($clientes as $c): ?>
                        <tr class="customer-row border-b border-gray-100 <?php echo $c['activo'] ? 'hover:bg-gray-50' : 'bg-red-50'; ?>"
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="customer_account.php?id=<?php echo $c['id']; ?>"
                                    class="text-gray-600 hover:text-gray-900 mr-2" title="Ver Cuenta">
                                    <i class="fas fa-file-invoice-dollar"></i>
                                </a>
                                <button onclick="editCustomer(<?php echo htmlspecialchars(json_encode($c)); ?>)"
                                    class="text-gray-600 hover:text-gray-900 mr-2" title="Editar">
            ...
            <form method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2 flex gap-2">
                    ...
                    <button type="submit" name="update_customer"
                        class="bg-gray-900 hover:bg-black text-white px-4 py-2 rounded-none shadow-none">Actualizar</button>
                </div>
            </form>
        </div>
    </div>
